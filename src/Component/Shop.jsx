    ...
    <div className="bg-[#0D0D0D]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 p-6">
        ...
        {products?.map((item) => (
          <div
            key={item.id}
            className="p-4 bg-[#1A1A1A] border rounded-xl shadow border-[#2f2f2f] 
          ...
          >
            ...
            >
              ...
              <h2 className="text-sm font-semibold text-[#D1D1D1]">
            ...
            <button
              onClick={() => {navigate('')}}
              className="w-full mt-2 bg-green-600 hover:bg-green-700 active:scale-95 
               transition py-2 rounded-lg text-white text-sm font-medium shadow-md"
            >
              🛒 Add to Cart
            </button>
